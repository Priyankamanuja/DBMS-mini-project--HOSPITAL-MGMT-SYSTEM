...
if(isset($_POST['entry_submit'])){
  ...
  $query="insert into appointmenttb(fname,lname,email,contact,doctor,payment,wid,allocated_staff) values ('$fname','$lname','$email','$contact','$doctor','$payment','$wid','$allocated_staff');";
